...
var aggregate = function () {
  ...
  (0, _createClass3.default)(aggregate, [{
    ...
    value: function buildFromHistory() {
      ...
      try {
        for (var _iterator = (0, _getIterator3.default)(historicalEvents), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          var de = _step.value;
    ...
    value: function _handleEvent(event) {
      ...
      try {
        for (var _iterator2 = (0, _getIterator3.default)(handlers), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
