...
var _watch_complile = require('./util/watch_complile');

var _watch_complile2 = _interopRequireDefault(_watch_complile);
...
var _class = function () {
  ...
  _createClass(_class, [{
    ...
    value: function loadSubModule(name) {
      var path = path.join(_config2.default.appPath, name);
      ...
      try {
        var _loop = function _loop() {
          ...
          _this._modules.forEach(function (module) {
            ...
            var filepath = '' + _config2.default.appPath + sep + module + sep + _this._dirname[itemType];
    ...
    value: function _registerHandler(name, itemtype, moduletype) {
      ...
      if (handlers != null) {
        (function () {
          handlerConfig = _config2.default.get(itemtype + 'handler', '' + _config2.default.appPath + sep + module + sep + _this2._dirname['config']);
          var configtypes = [];
    ...
    value: function compile(srcPath, outPath) {
      ...
      srcPath = srcPath || '' + _config2.default.appPath + sep + '..' + sep + 'src';
      ...
      if ((0, _utils.isDir)(srcPath)) {
        (function () {
          ...
          var instance = new _watch_complile2.default(srcPath, outPath, options, _this4.compileCallback);
          instance.run();
