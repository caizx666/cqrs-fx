  ...
  (0, _createClass3.default)(_class, [{
    ...
    value: function compile(srcPath, outPath) {
      ...
      if ((0, _utils.isDir)(srcPath)) {
        (function () {
          var reloadInstance = _this3.getReloadInstance(outPath);
          _this3.compileCallback = function (changedFiles) {
            reloadInstance.clearFilesCache(changedFiles);
          };
          var instance = new _watch_compile2.default(srcPath, outPath, options, _this3.compileCallback);
          instance.run();
