...
var _class = function () {
  ...
  (0, _createClass3.default)(_class, [{
    ...
    value: function loadCQRS() {
      ...
      try {
        for (var _iterator4 = (0, _getIterator3.default)(this._types), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
          var _itemType = _step4.value;

          if (itemtype == 'command' || itemtype == 'event') this._registerHandler(name, _itemType);
          if (itemtype == 'domain') this._registerDomain(name, _itemType);
        }
      } catch (err) {
    ...
    value: function preload() {
      ...
      for (var _name2 in _core.fxData.alias) {
        (0, _core.getType)(_core.fxData.alias[_name2]);
      }
