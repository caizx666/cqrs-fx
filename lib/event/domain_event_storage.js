...
var _class = function () {
  function _class() {
    ...
    if (!eventStorage) throw Error(_err2.default.configFailed, '事件存储服务未正确配置，可以在config/event.js中指定');
  ...
  (0, _createClass3.default)(_class, [{
    key: 'loadEvents',
    value: function () {
      var _ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee(name, id, version) {
        var results, events;
...
//# sourceMappingURL=domain_event_storage.js.map